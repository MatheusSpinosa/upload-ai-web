      ...
      <main className="flex-1 flex p-6 gap-6">
        <div className="flex flex-col flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: você pode ultilizar a variável <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transcrição do vídeo selecionado.
          </p>
        </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                placeholder="Inclua palavras-chave mencinadas no víde separadas por vírgula (,)"
              />
            </div>
